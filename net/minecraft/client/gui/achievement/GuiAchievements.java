...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    public GuiAchievements(GuiScreen parentScreenIn, StatFileWriter statFileWriterIn)
    {
        ...
        int i = 141;
        int j = 141;
        this.field_146569_s = this.field_146567_u = this.field_146565_w = AchievementList.openInventory.displayColumn * 24 - i / 2D - 12;
        this.field_146568_t = this.field_146566_v = this.field_146573_x = AchievementList.openInventory.displayRow * 24 - j / 2D;
    }
        ...
        for (int i6 = 0; i6 < AchievementList.achievementList.size(); ++i6)
        {
            ...
            if (l6 >= -24 && j7 >= -24 && (float)l6 <= 224.0F * this.field_146570_r && (float)j7 <= 155.0F * this.field_146570_r)
            {
                ...
                if (!this.statFileWriter.canUnlockAchievement(achievement2))
                {
                    ...
                    this.itemRender.isNotRenderingEffectsInGUI();
                }
