...
public class RenderManager
{
    ...
    public void renderEntityStatic(Entity entity, float partialTicks, boolean hideDebugBox)
    {
        ...
        this.doRenderEntity(entity, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, partialTicks, hideDebugBox);
    }
    ...
    public void doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean hideDebugBox)
    {
